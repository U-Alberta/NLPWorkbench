...
def call(cmd_args=None, model_manager=None):
    ...
    parser.add_argument('--task', type=str, default='ace05', required=False, choices=['ace04', 'ace05', 'scierc'])
    ...
    parser.add_argument('--context_window', type=int, required=False, default=300, 
    ...
    for chunk in tqdm(test_data.chunks(100)):
        test_samples, test_ner = convert_dataset_to_samples(chunk, args.max_span_length, ner_label2id=ner_label2id, context_window=args.context_window)

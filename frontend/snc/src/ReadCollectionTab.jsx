...
import { Typography, TextField, Button, ToggleButton, ToggleButtonGroup, Select, MenuItem, Box, Radio, Checkbox, RadioGroup, FormGroup, FormControlLabel, FormControl, FormLabel, Snackbar, Alert, List, ListItem, ListItemText, Dialog, DialogTitle, DialogContent, DialogActions} from '@mui/material';
...
class ReadCollectionTab extends Component {
    constructor(props) {
        super(props);
        this.state = {
            userInput: '', 
...
export default ReadCollectionTab;
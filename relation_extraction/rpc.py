...
class RPCServer:
    def __init__(self):
        ...
        warnings.warn("RPCServer is deprecated. Use celery instead.", DeprecationWarning)
...
class RPCClient:
    def __init__(self, host, port):
        ...
        warnings.warn("RPCClient is deprecated. Use celery instead.", DeprecationWarning)
